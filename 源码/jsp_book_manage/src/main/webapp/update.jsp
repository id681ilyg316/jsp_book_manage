...
<div class="topbar-wrap white">
    <div class="topbar-inner clearfix">
        <div class="topbar-logo-wrap clearfix">
            <h1 class="topbar-logo none"><a href="/book.do?type=show" class="navbar-brand">简单图书管理系统后台</a></h1>
...
<div class="container clearfix">
    <div class="sidebar-wrap">
        ...
        <div class="sidebar-content">
            <ul class="sidebar-list">
                <li>
                    <ul class="sub-menu">
                        <li><a href=""><i class="icon-font">&#xe005;</i>图书管理</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/book.do?type=pageList">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="">图书管理</a><span class="crumb-step">&gt;</span><span>修改信息</span></div>
        </div>
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form  id="add-book"  enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="formerImg" value="${book.img}">
                    <table class="insert-tab" width="100%">
                        <tbody>
                             <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="bookname" size="50" value="${book.name}" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th width="120">
                            ...
                            <tr>
                                <th>价格：</th>
                                <td>
                                    <input type="number" name="price" value="${book.price}" min="0" max="1000"  class="common-text">
                                </td>
                            </tr>
                            <tr>
                                <th>作者：</th>
                                <td>
                                    <input class="common-text" name="author" size="50" value="${book.author}" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>出版日期：</th>
                                <td>
                                    <input type="date" name="pdate" value="${book.pdate}" min="1900-01-01" max="2018-04-12" class="common-text">
                                </td>
                            </tr>
                            <tr>
                                <th>位置：</th>
                                <td>
                                    <input class="common-text" name="address" value="${book.address}" size="50" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>描述：</th>
                                <td>
                                    <input class="common-text" name="description" value="${book.description}" size="50"  type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>
...
<script>
    var detail=$('#detail-content').html();
    ue.ready(function () {
        //设置编辑器的内容
